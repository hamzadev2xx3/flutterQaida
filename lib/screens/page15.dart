...
class Page15State extends State<Page15> {
  ...
  List<String> audioFilePaths = [
    'assets/page15/00.mp3',
    'assets/page15/01.mp3',
    'assets/page15/02.mp3',
    'assets/page15/03.mp3',
    'assets/page15/04.mp3',
    'assets/page15/05.mp3',
    'assets/page15/06.mp3',
    'assets/page15/07.mp3',
    'assets/page15/08.mp3',
    'assets/page15/09.mp3',
    'assets/page15/10.mp3',
    'assets/page15/11.mp3',
    'assets/page15/12.mp3',
    'assets/page15/13.mp3',
    'assets/page15/14.mp3',
    'assets/page15/15.mp3',
  ];
  ...
  void _toggleSelection(int index, String filePath) {
    if (_startIndex != null && _endIndex != null) {
      ...
      _startIndex = null;
      _endIndex = null;
      AudioListHolder15.audioList.clear();
      ...
      AudioListHolder15.audioList = selectedAudioFiles;
...
class AudioListHolder15 {
  static List<String> audioList = [];
  static int pageId = 15;
}
